...
| Criterio                                                                   | Integrante                        | Acción / Evidencia                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Conclusión                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| -------------------------------------------------------------------------- | --------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Comunica oralmente con efectividad a diferentes rangos de audiencia.**   | **Delgado Perez, James Caleb**    | **AV1:** Participé en la coordinación y comunicación de las decisiones tomadas durante el desarrollo de MaquiGest, explicando al equipo los avances relacionados con la propuesta del producto, el diseño de la Landing Page y la arquitectura de software. Asimismo, comuniqué las decisiones adoptadas para la organización del frontend mediante bounded contexts, las capas de Domain-Driven Design y los diagramas C4 de Context, Container y Components, facilitando que los integrantes comprendieran la estructura y responsabilidades de los diferentes componentes de la solución.                                                                                                                                                                                                                                       | **AV1:** El AV1 permitió presentar y explicar el avance del proyecto MaquiGest durante el Sprint 1, incluyendo la problemática y propuesta de valor, los principales artefactos de UX y Product Design, la arquitectura planteada y la primera versión funcional y desplegada de la Landing Page. También permitió comunicar la organización del trabajo y la aplicación de herramientas y prácticas como GitFlow, GitHub, Figma y despliegue.           |
| **Comunica oralmente con efectividad a diferentes rangos de audiencia.**   | **Daga Chávez, Joaquin Leonardo** | **AV1:** Participé en la comunicación y coordinación de los resultados obtenidos durante las entrevistas realizadas para MaquiGest, presentando los principales problemas, necesidades y patrones identificados en el proceso de alquiler de maquinaria. Asimismo, participé en la explicación y discusión de los artefactos de Big Picture Event Storming, Ubiquitous Language y Design-Level Event Storming, comunicando los principales eventos, conceptos, actores y procesos identificados para facilitar la comprensión y alineación del equipo.                                                                                                                                                                                                                                                                             | **AV1:** El AV1 permitió fortalecer la comunicación oral de información relacionada con el análisis de usuarios y el dominio de MaquiGest. La presentación de los resultados de las entrevistas y la explicación de los artefactos de Event Storming permitieron transmitir información de negocio y aspectos técnicos de manera clara, contribuyendo a la comprensión de las necesidades identificadas y de las decisiones tomadas durante el proyecto. |
| **Comunica por escrito con efectividad a diferentes rangos de audiencia.** | **Delgado Perez, James Caleb**    | **AV1:** Contribuí en la elaboración y mejora de la documentación técnica del proyecto MaquiGest. Desarrollé y documenté artefactos correspondientes al diseño de la Landing Page, incluyendo wireframes y mock-ups, y participé en la elaboración de la arquitectura de software mediante diagramas C4 de Context, Container y Components utilizando PlantUML. Asimismo, documenté la arquitectura frontend considerando los bounded contexts IAM, Profiles, Inventory, Rentals, Maintenance y Subscriptions, sus capas Presentation, Application, Domain e Infrastructure, así como los componentes compartidos de Shared Frontend. También participé en la implementación de secciones de la Landing Page, la configuración del despliegue mediante Netlify, el versionamiento con Git y GitHub y la actualización del informe. | **AV1:** El AV1 permitió documentar formalmente los avances del proyecto, incluyendo la planificación, diseño, arquitectura, desarrollo, despliegue y colaboración del equipo durante el Sprint 1. La documentación permitió consolidar los diferentes artefactos y decisiones técnicas del proyecto de manera estructurada y facilitar su consulta durante el desarrollo.                                                                               |
| **Comunica por escrito con efectividad a diferentes rangos de audiencia.** | **Daga Chávez, Joaquin Leonardo** | **AV1:** Contribuí en la elaboración y actualización de la documentación del proyecto MaquiGest mediante el registro y análisis de las entrevistas realizadas y de los principales hallazgos obtenidos. También documenté los artefactos correspondientes al Big Picture Event Storming, Ubiquitous Language y Design-Level Event Storming, organizando los conceptos, eventos, actores y procesos identificados en el dominio. Además, participé en la actualización y versionamiento del informe utilizando Git y GitHub, manteniendo la documentación estructurada de acuerdo con las convenciones establecidas por el equipo.                                                                                                                                                                                                  | **AV1:** El AV1 permitió fortalecer la comunicación escrita mediante la documentación formal de los resultados del análisis de usuarios y del modelado del dominio de MaquiGest. La organización de las entrevistas y de los artefactos de Event Storming permitió convertir la información obtenida en contenido claro y estructurado, facilitando su consulta por parte del equipo y sirviendo como base para las siguientes actividades del proyecto. |
